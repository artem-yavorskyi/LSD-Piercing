        ...
        <div className="cards-container">
          <div className="care-card">
            ...
            <div className="card-content">
              <p>
                &nbsp;&nbsp;&nbsp;Протягом 25 днів 3 рази на день промиваємо
                розчином Мірамістину або «Angel tears» (спрей, який можна
                придбати на студії) кімнатної температури. Обережно вимиваємо
                виділення ватним диском або ватною паличкою (НЕ використовувати
                вату).
              </p>
              ...
              <div className="care-note">
                ...
                <div className="note-content">
                  Ввечері можливий біль і опухлість — це нормальна реакція. Для
                  полегшення можна прийняти знеболювальне.
                </div>
              </div>
          ...
          <div className="care-card">
            ...
            <div className="card-content">
              <p>
                &nbsp;&nbsp;&nbsp;Протягом 25 днів 3 рази на день промиваємо
                пірсинг розчином Мірамістину або спреєм кімнатної температури.
                Виділення обережно вимиваємо ватним диском або паличкою (НЕ
                використовувати вату).
              </p>
              <p>
                &nbsp;&nbsp;&nbsp;Перші 7 днів при контакті з одягом формуємо
                бар'єр із ватних дисків або бафів (НЕ пластир). Вдома краще
                носити відкритий одяг.
              </p>
          ...
          <div className="care-card">
            ...
            <div className="card-content">
              <p>
                &nbsp;&nbsp;&nbsp;Протягом 30 днів промивати розчином для
                ротової порожнини без спирту і смаків. Не травмувати прикрасу,
                не їсти сильно гарячі/холодні продукти, не вживати алкоголь і
                каву.
              </p>
          ...
          <div className="care-card">
            ...
            <div className="card-content">
              ...
              <p>
                &nbsp;&nbsp;&nbsp;Промивати 25 днів 3 рази на день розчином
                Мірамістину або «Angel tears». Виділення очищати ватним диском
                або паличкою (НЕ вата).
              </p>
              ...
              <p>
                &nbsp;&nbsp;&nbsp;Промивати 30 днів розчином для ротової
                порожнини без спирту і смаків. Перших 3 години — тільки
                негазована вода.
              </p>
              <p>
                &nbsp;&nbsp;&nbsp;Перший тиждень: уникати гострої, солоної,
                гарячої їжі; після кожного прийому їжі промивати.
              </p>
              <p>
                &nbsp;&nbsp;&nbsp;7–30 день: повернення до звичайного
                харчування, промивати 3 рази на добу.
              </p>
            </div>
          </div>
        </div>
